...
/**
 * MAssessHandled entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "m_assess_handled", catalog = "")
public class MAssessHandled implements java.io.Serializable {
	...
	/** default constructor */
	public MAssessHandled() {
	}

	/** full constructor */
	public MAssessHandled(Integer userId, Integer sex, Integer age,
			Integer age1, Integer nation, Integer sheng, Integer livewith,
			Integer education, Integer job, Integer sourceincome,
			Integer booleanIncome, Integer economic, Integer residenc,
			Integer marriage, Integer b11, Integer b12, Integer b13,
			Integer b21, Integer b22, Integer b23, Integer b24, Integer b25,
			Integer b26, Integer b27, Integer goodEmotion, Integer badEmotion,
			Integer c11, Integer c12, Integer c13, Integer c14, Integer c15,
			Integer c16, Integer c211, Integer c212, Integer c213, Integer c22,
			Integer c311, Integer c312, Integer c313, Integer c314,
			Integer c315, Integer c32, Integer c411, Integer c412,
			Integer c413, Integer c511, Integer c512, Integer c52,
			Integer c521, Integer c522, Integer c531, Integer c532,
			Integer c533, Integer score, Integer d11, Integer d12,
			Integer DConstruct, Integer d221, Integer d2211, Integer d222,
			Integer d2221, Integer d223, Integer d2231, Integer DConnow,
			Integer DConnow60, Integer d31, Integer d32, Integer d3Con,
			Integer d41, Integer d42, Integer d4Con, Integer e1, Integer e2,
			Integer e3, Integer e4, Integer e5, Integer e6, Integer ECon,
			Integer f11, Integer f12, Integer f1Con, Integer f21, Integer f31,
			Integer f32, Integer f33, Integer f34, Integer f35, Integer f36,
			Integer f37, Integer f38, Integer f4, Integer f3Con,
			Integer f3Con1, Integer g1, Integer g01, Integer g02, Integer g03,
			Integer g04, Integer g05, Integer g06, Integer g07, Integer g08,
			Integer g09, Integer g10, Integer g11, Integer g12, Integer g13,
			Integer g14, Integer g15, Integer GCon, Integer GJibing,
			Date createdAt) {
		this.userId = userId;
		this.sex = sex;
		this.age = age;
