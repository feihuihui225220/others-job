...
/**
 * MAssessHandle entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "m_assess_handle", catalog = "")
public class MAssessHandle implements java.io.Serializable {
	...
	/** default constructor */
	public MAssessHandle() {
	}

	/** full constructor */
	public MAssessHandle(Integer userId, Integer sex, Integer age,
			...
			Integer b24, Integer b25, Integer b26, Integer b27, Integer c11,
			Integer c12, Integer c13, Integer c14, Integer c15, Integer c16,
			Integer c211, Integer c212, Integer c213, Integer c22,
			...
			Integer c533, Integer d11, Integer d12, Integer d221,
			Integer d2211, Integer d222, Integer d2221, Integer d223,
			Integer d2231, Integer d31, Integer d32, Integer d41, Integer d42,
			Integer e1, Integer e2, Integer e3, Integer e4, Integer e5,
			Integer e6, Integer f11, Integer f12, Integer f21, Integer f31,
			Integer f32, Integer f33, Integer f34, Integer f35, Integer f36,
			Integer f37, Integer f38, Integer f4, Integer g1, Integer g01,
			Integer g02, Integer g03, Integer g04, Integer g05, Integer g06,
			Integer g07, Integer g08, Integer g09, Integer g10, Integer g11,
			Integer g12, Integer g13, Integer g14, Integer g15, Date createdAt) {
		this.userId = userId;
		this.sex = sex;
		this.age = age;
		this.nation = nation;
