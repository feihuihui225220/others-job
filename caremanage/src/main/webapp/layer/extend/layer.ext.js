        ...
        page: {
            html: '<div class="xubox_bigimg"><img src="'+ log.thissrc +'" alt="'+ (log.name || '') +'" layer-pid="'+ (log.pid || '') +'"><div class="xubox_imgsee">'+ function(){
                if(log.imgLen > 1){
                    ...
                    return '';
                }                                                                          //'+ log.imgsname +' 此处可以添加缩略图   
            }() +'<div class="xubox_imgbar"><span class="xubox_imgtit"><a href="javascript:;"></a><em>'+ log.imgIndex +'/'+ log.imgLen +'</em></span></div></div></div>'+ function(){
                if(options.html){
                    return '<div class="xubox_intro"><div><br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;相册描述：<br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;'+ (log.name || '暂无') +options.html +'</div></div>';
                } else {
                    return '';
                }
            }()
