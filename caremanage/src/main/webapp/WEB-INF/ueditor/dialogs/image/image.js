...
//                }
        ...
        callback: function (editor, $w, url, state) {
                var urls=editor.options.imagePath.replace("/ueditor/jsp/", "")
        	//显示图片计数+1
                Upload.showCount++;
                var $img = $("<img src='"  + ings_urls + "' class='edui-image-pic' />"),
    ...
    var Upload = {
        ...
        config: function (sel) {
            ...
            url="/ICareFitness/zfitness/imgs";
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                $('<iframe name="up"  style="display: none"></iframe>').insertBefore(me.dialog).on('load', function(obj){
