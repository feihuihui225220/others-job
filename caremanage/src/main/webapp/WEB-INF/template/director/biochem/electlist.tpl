  ...
  <div>
    <div class="personInfo_right fl" style="float: left;">
	 ...
	 #foreach($li in $list)
		...
		<td>$li.changeTime</td>
		<td name="potassium">$li.potassium</td>
		<td name="sodium">$li.sodium</td>
		<td name="chlorine">$li.chlorine  </td>
		<td name="calcium">$li.calcium</td>
		<td name="phosphorus">$li.phosphorus</td>
...
$(function(){       
    ...
    tds.click(function(){  
        ...
        input.blur(function(){  
            ...
            $.ajax({   
                type:"post",  
                url: "/director/editElect?userId="+userId+"&id="+id+'&'+param,   
