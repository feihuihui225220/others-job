  ...
  <div>
    <div class="personInfo_right fl" style="float: left;">
	  ...
	  <table width="100%" border="0" cellspacing="0" cellpadding="7" class="commonTable" id="dayin">
		...
		<th>三碘甲状腺原氨酸（T3）</th>
		<th>甲状腺素（T4）</th>
		<th>游离三碘甲状腺原氨酸（FT3） </th>
		<th>游离甲状腺（FT4）</th>
		<th>促甲状腺素(TSH)</th>
		<th>抗甲状腺球蛋白抗体（TGAb） </th>
		<th>抗甲状腺过氧化物酶抗体（TPOAb） </th>
		<th>甲状旁腺激素（PTH）</th>
		<th>血清胰岛素</th>
		<th>降钙素</th>
	 </tr>
	 #foreach($li in $list)
		...
		<td name="t3">$li.t3</td>
		<td name="t4">$li.t4</td>
		<td name="ft3">$li.ft3  </td>
		<td name="ft4">$li.ft4</td>
		<td name="tsh">$li.tsh</td>
		<td name="tgab">$li.tgab</td>
		<td name="tpoab">$li.tpoab</td>
		<td name="pth">$li.pth</td>
		<td name="serumInsulin">$li.serumInsulin</td>
		<td name="calciumReducingHormone">$li.calciumReducingHormone</td>
		</tr>
		#end
	 </table>
...
$(function(){       
    ...
    tds.click(function(){  
        ...
        input.blur(function(){  
            ...
            $.ajax({   
                type:"post",  
                url: "/director/editHor?userId="+userId+"&id="+id+'&'+param,   
