...
#set ($sessionUser=$!{session.getAttribute("sessionUser")})
					<div class="new_user_dj" style="float:left;margin:20px;">
						<form action="/group/add" method="post" name="form" id="form">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tbody>
									<tr>
										<td align="right"><strong>巡诊组名称：</strong></td>
										<td align="left"><input type="text" name="userName" id="userName"  class="txt_input" placeholder="请填写巡诊组名称"></td>
									</tr>
									<tr>
										<td align="right"><strong>医生：</strong></td>
										<td align="left">
											<input type="text" name="doctor" class="txt_input" id="doctor"  placeholder="请填写医生名称"></td>
										</td>
									</tr>
									<tr>
										<td align="right"><strong>护士：</strong></td>
										<td align="left">
											<input type="text" name="nurse" class="txt_input" id="nurse"  placeholder="请填写护士名称"></td>
										</td>
									</tr>
									<tr><input type="hidden"   name="community" class="community_">
										<td>
										</td>
										<td><input  type="button" class="btn_cancle btn_cancle_sub" value="确定">
											<input type="button"  class="btn_cancle fanhui" onclick="history.back();" value="取消"></td>
									</tr>
								</tbody>
							</table>
						</form>
