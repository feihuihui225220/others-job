...
<html>
  <head>
    <title>协议展示</title>
	<meta charset="UTF-8">
	<script type="text/javascript"  src="../assets/ueditor/umeditor.config.js"></script>
	<script type="text/javascript"  src="../assets/ueditors/ueditor.config.js"></script>
	<script type="text/javascript"  src="../assets/ueditors/ueditor.all.min.js"> </script>
  </head>
