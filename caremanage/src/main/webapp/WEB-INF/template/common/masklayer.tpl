...
<body id="container_mask" style="margin: 0;padding: 0px;">
    <div id="in_mask" style="width: 100%;height: 100%;position: fixed;z-index: 9999;text-align:center;line-height: 100%;background: rgba(0,0,0,0.2);"></div>
</body>
<script>
    (function(){
...
<script>
    ...
    var d, a, container = document.getElementById('in_mask');
