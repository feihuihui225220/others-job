...
#main{margin-left:10%;width:80%;margin-top:20px;}
</style>
</head>
<body>
	<div class="wrapper">
			...
			<div class="r_right">
				...
				<table class="table _tale1  select_1">
					<tr class="_active">
						...
						<td ><label for="xheck">$nActivityPlan.siteIdName<input id="xheck" class="xheck inputcj" type="checkbox"/></label></td>
						<td><a
							href="/professional/activity/tiaozhuan?id=$nActivityPlan.id"
							id=$nActivityPlan.id>编辑</a><input class="print1" type="checkbox">打印</td>
						<td><a
							href="/professional/activity/activity_aged?id=$nActivityPlan.id&siteId=$nActivityPlan.siteIds&communityId=0&pubdate= $!date.format('yyyy-MM-dd',$nActivityPlan.pubdate)">签到</a><input class="print2" type="checkbox">打印</td></td>
						<td><a
							href="/professional/activity/activity_voluntary?id=$nActivityPlan.id&&pubdate=$!date.format('yyyy-MM-dd',$nActivityPlan.pubdate)">签到</a><input class="print3" type="checkbox">打印</td></td>
						<td><a>查看</a></td>
						<td><a>查看</a></td>
					</tr>
				</table>
			</div>
			<div id="myPrintArea" style="font-size:20px;font-family:楷体;">
				<table class="table _tale1 mytable print_1 print">
					<tr class="_active">
				...
				<div>
					<table class="table _tale1 print_2 print">
						<tr class="_active">
						...
						#foreach($user in $rUser) #set($x = $velocityCount+1)
				...
				<div class="PagerPrint"></div>
				<div>
					<table class="table _tale1 print_3 print">
						<tr class="_active">
...
<script>
	$(function() {
		...
		$('#dayin').click(function() {
			...
			if($('.print2').prop('checked')==true){
				$(".print_2").show();
				$('.print_2').addClass("myPrintArea");
			}
			if($('.print3').prop('checked')==true){
				$(".print_3").show();
				$('.print_3').addClass("myPrintArea");
			}
