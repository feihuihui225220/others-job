...
.rightbtn button{line-height:16px;}
...
#set($actparam = {'on':{'label':'在床','color':'#00AA00'},
									'off':{'label':'离床','color':'#AA0000'},
									'mov':{'label':'体动','color':'#FF0000'},
									'call':{'label':'呼叫','color':'#008888'}})
<div class="wrapper">
          	...
          	<div class="row">
          		...
          		<div class="col-sm-6">	
          			<ul class="pager pull-right">
		           		<li><a href="/professional/service/history?userId=$!userId&serviceId=$!serviceId&type=$!stype&start=$!date.format('yyyy-MM-dd',$!preweek.start)&end=$!date.format('yyyy-MM-dd',$!preweek.end)">&larr;上一周</a></li>
		              <li><a href="/professional/service/history?userId=$!userId&serviceId=$!serviceId&type=$!stype&start=$!date.format('yyyy-MM-dd',$!nextweek.start)&end=$!date.format('yyyy-MM-dd',$!nextweek.end)">下一周&rarr;</a></li>
		            </ul>
          		</div>
          	</div>
    </div>
