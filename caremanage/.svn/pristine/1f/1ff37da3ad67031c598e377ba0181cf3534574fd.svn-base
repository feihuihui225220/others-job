    ...
    <div class="body">
        <div class="useractbox bodyline pad10">
            <ul class="clourstitle strong mgb10">
             ...
             <li index="4" class="rel  on" onclick='location.href="findCategoryRounds?parentId=1"'>巡诊管理</li>
            </ul>
                ...
                <div class="actbox2">
                    <div class="l4">
                        ...
                        <table class="tb table_col2 tab_115" trclick>
                            ...
                            <tr>
                                <td ><a href="findCategoryRounds?parentId=$!{sc.id}" target="_self">$!{sc.name}</a>
...
<form action="addHVisit" method="post" name="statueType" id="statueType">
<div class="limitbox2 pad10 hide" style="height:90px;">
    <ul class="inpubox clearfix">
    #set ($sessionUser=$!{session.getAttribute("sessionUser")})
        <li><label>名称：</label><input class="text150" type="text" name="name"  id="name" /></li>
...
<form action="editHVisitCategoryById" method="post" name="editType" id="editType">
...
<form action="editHVisitCategoryById" method="post" name="editTypeValue" id="editTypeValue">
<div class="limitbox4 pad10 hide">
    <ul class="inpubox clearfix">
    
    #set ($sessionUser=$!{session.getAttribute("sessionUser")})
        <li class="catename2"><label>分类内容：</label><input class="text150" type="text" name="name"  id="nameValue" /></li>
