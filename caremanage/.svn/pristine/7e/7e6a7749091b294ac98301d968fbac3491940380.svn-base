...
function getCurrentDateTime() {
	...
	/* 时分秒 */
	/*
	 * var hours = d.getHours(); var minutes = d.getMinutes(); var seconds =
	 * d.getSeconds(); var ms = d.getMilliseconds();
	 */
	...
	/*
	 * if (hours > 9) curDateTime = curDateTime + " " + hours; else curDateTime =
	 * curDateTime + " 0" + hours; if (minutes > 9) curDateTime = curDateTime +
	 * ":" + minutes; else curDateTime = curDateTime + ":0" + minutes; if
	 * (seconds > 9) curDateTime = curDateTime + ":" + seconds; else curDateTime =
...
function GetcDateString() {
	...
	/* 显示农历年：（ 如：甲午(马)年 ） */
	/*
	 * tmp+=tgString.charAt((cYear-4)%10); tmp+=dzString.charAt((cYear-4)%12);
	 * tmp+="("; tmp+=sx.charAt((cYear-4)%12); tmp+=")年 ";
	 */
	if (cMonth < 1) {
		tmp += "(闰)";
