  ...
  <div>
    <div class="personInfo_right fl" style="float: left;">
	 ...
	 #foreach($li in $list)
		...
		<td>$li.changeTime</td>
		<td name="urineSpecificGravity">$li.urineSpecificGravity</td>
		<td name="ph">$li.ph</td>
		<td name="whiteBloodCell">$li.whiteBloodCell  </td>
		<td name="redBloodCell">$li.redBloodCell</td>
		<td name="nitrite">$li.nitrite</td>
		<td name="protein">$li.protein</td>
		<td name="glucose">$li.glucose</td>
		<td name="ketone">$li.ketone</td>
		<td name="urinaryBladder">$li.urinaryBladder</td>
		<td name="urineBilirubin">$li.urineBilirubin</td>
		</tr>
		#end
	 </table>
...
$(function(){       
    ...
    tds.click(function(){  
        ...
        input.blur(function(){  
            ...
            $.ajax({   
                type:"post",  
                url: "/director/hUrineEdit?userId="+userId+"&id="+id+'&'+param,   
