...
<div class="wrapper">
        ...
        <div class="useractbox bodyline pad10" id="right">
            <div class="strong usertitle pad10">试题</div>
            <div class="ql">
            </div>
            <form name="form1" method="post" action="/professional/assess/site/commit">
                ...
                <div class="bodyline pad10">
                    ...
                    <input type="hidden" name="type" value="2" id="detail" />
                    <p class="opt pad10 admin_cate_opt">
                        <button type="submit" class="btn button_btn button_gm" style="color:#999">完 成</button>
                        ...
                        (function (index) {
                          ...
                          // alert(json.data[0].qaList[i].picture);
                            for (var j=0; j<json.data[0].qaList[index].answers.length; j++) {
                              ...
                              //  alert(json.data[0].qaList[index].assessType==true);
...
//                     	 num+=1;
                ...
                $('.aa').click(function () {
                   ...
                   // alert(arr[i].lowerLimit+"==========="+arr[i].upperLimit);
