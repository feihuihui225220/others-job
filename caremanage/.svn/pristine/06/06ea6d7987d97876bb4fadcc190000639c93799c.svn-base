        ...
        if (dateArray[i]){
            tds[i].onclick = function () {
                ...
                for (var j=0; j<tds.length; j++) {
                    ...
                    tds[j].style.color = '';
                    tds[j].style.fontSize = '';
                }
                this.style.fontWeight = 'bold';
                this.style.color = '#0093bf';
...
Calendar.prototype.show = function (dateControl, popuControl) {
    ...
    this.panel.style.marginLeft = 0 + "px";//相对于召唤出他的组件的位置
    this.panel.style.marginTop = 0 + "px";
    this.panel.style.width=300+"px";
...
var divs = [];
divs[divs.length] = '<div id="__calendarPanel" style="position:absolute;display:none;background-color:#FFFFFF;border:1px solid #666666;width:400px;height:190px;">';
...
cis[cis.length] ='<!--';
cis[cis.length] ='body {font-size:14px;margin:0px;text-align:center;}';
...
cis[cis.length] ='th {font-size:14px;font-weight:normal;background-color:#FFFFFF;padding:5p 0}';
...
cis[cis.length] ='td {font-size:14px;text-align:center;}';
...
cis[cis.length] ='input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:20px;display:none;}';
cis[cis.length] ='-->';
