...
import javax.persistence.Table;
   ...
   /**
    * n_service_record 服务记录
    * Mon Sep 07 09:40:23 CST 2015  baishuangdong
    */ 

@Entity
@Table(name = "n_service_record")
public class NServiceRecord{
	...
	@Column(name = "record_name", nullable = true)
