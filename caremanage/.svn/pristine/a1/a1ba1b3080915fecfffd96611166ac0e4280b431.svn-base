...
{		
	...
	public void setWaist(short nVal) 		{ waist = nVal; 	}
	public void setHip(short nVal) 		{ hip = nVal; 	}
	public void setHeight(short nVal) 	{ height = nVal;}
	public void setWeight(short nVal) 	{ weight = nVal; 	}
	public void setPulse(short nVal) 		{ pulse = nVal; }
	public void setSbp(short nVal) 		{ sbp = nVal; 	}
	public void setDbp(short nVal) 		{ dbp = nVal; 	}
	public void setHbA1c(float fVal) 		{ hbA1c = fVal; }
	public void setFpg(float fVal) 		{ fpg = fVal; 	}
	public void setOgtt(float fVal)		{ ogtt = fVal; 	}
	public void setTc(float fVal) 		{ tc = fVal; 	}
	public void setLdlc(float fVal)		{ ldlc = fVal; 	}
	public void setHdlc(float fVal) 		{ hdlc = fVal; 	}
	public void setTg(float fVal) 		{ tg = fVal; 	}
}
