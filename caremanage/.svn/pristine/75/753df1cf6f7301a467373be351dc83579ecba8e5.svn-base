        ...
        <div class="">
            <div class="admin_cate_opt">
               ...
               <table class="tb table_col1 tab_115">
                  ...
                  <tr>
                     <td>$!vo.FName</td>
                     <td style="padding-left: 5%;"><a href="/ICareFitness/zfitness/savevoid?fid=$!vo.FId&parentId=$!vo.parentId"> 修改 </a>&nbsp;&nbsp;<a href="/ICareFitness/zfitness/conclusion?fid=$!vo.FId">  结论 </a><!-- <a class="putaway"  href="/ICareFitness/zfitness/savevoid?parentId=$!vo.FId">试题</a>&nbsp;&nbsp; -->
...
<script>
    $(function(){
        ...
        $('.delete_').click(function(){
            ...
            location.href="/ICareFitness/combo/remove?id="+id;
        });
