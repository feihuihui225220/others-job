    ...
    <div class="body">
        <div class="useractbox bodyline pad10">
            <ul class="clourstitle strong mgb10">
               ...
               <li index="2" class="rel  on" onclick='location.href="findStatueCategory?parentId=1"'>状态管理</li>
                ...
                <div class="actbox2">
                    <div class="l4">
                        <div class="admin_cate_opt clearfix">
                            <button class="btn button_add">添 加</button>状态分类
                        ...
                        <table class="tb table_col2 tab_115" trclick>
                            ...
                            #if($statueCategory)
                            	#foreach($sc in $statueCategory)
                            <tr>
                                <td ><a href="findStatueCategory?parentId=$!{sc.id}" target="_self">$!{sc.name}</a>
                               
                                </td>                   
                                <td cateId="$!{sc.id}"><span class="tb_edit button_add">编 辑</span>                              
                    ...
                    <div class="r6">
                        ...
                        <table class="tb table_col2 tab_115">
                            ...
                            #if($statueCategoryValue)
                            	#foreach($scv in $statueCategoryValue)
                            <tr>         
                                <td>$!{scv.name}</td> 
                                <td _id="${scv.id}"><span class="tb_edit button_add" >编 辑</span>
                                 <!--<span class="tb_remove">删 除</span>-->
                                 #end
                            #end
                            </tr>
...
<form action="addStatueType" method="post" name="statueType" id="statueType">
...
<form action="editStatueCategoryById" method="post" name="editType" id="editType">
...
<form action="editStatueCategoryById" method="post" name="editTypeValue" id="editTypeValue">
